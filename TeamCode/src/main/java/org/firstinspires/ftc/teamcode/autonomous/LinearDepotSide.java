...
public class LinearDepotSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.encoderDrive(0.5, 50, 50, 15);
        ...
        robot.encoderDrive(0.5, -36, -36, 10);

        //turn towards crater
        robot.encoderTurn(0.25, 90, false, 10);

        //drive towards wall
        robot.encoderDrive(0.5, 35, 35, 10);

        //turn so that the robot is parallel to the wall
        robot.encoderTurn(0.25, 120, false, 5);
